...
if (!isset($_SESSION['matricule'])) {
  ...
  $infos_connecte = $pdo->query('SELECT * FROM personnel WHERE matricule_personnel="'.$_SESSION['matricule'].'"');
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-left" >
                   <a href="<?php if(isset($matricule)){echo $photo;} ?>"> <img class="rounded-circle shadow" style="width: 12rem; height: 12rem;border:1px solid lightblue" src="<?php if(isset($matricule)){echo $photo;} ?>" alt=""></a>
                  </div>
                  <p>
